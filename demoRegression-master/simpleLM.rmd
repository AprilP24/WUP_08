...
This chart has the highest residual error of 10.99 which is bad. Then the R- squared is 0.00423 which is now the lowest besides the AGE chart above. This data gives us a different chart, showing more blocks then dots
